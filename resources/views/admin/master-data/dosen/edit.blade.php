...
@section('content')
    <div class="body flex-grow-1">
        <div class="container-lg px-4 mb-4">
            ...
            @endif
            <form action="/master-data/dosen/{{ $dosen->id }}/update" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row g-3">
                    <div class="col-12">
                    ...
                    <div class="col-12">
                        ...
                        <select required name="prodi_id" id="prodi_id" class="form-select">
                            @foreach ($daftarProdi as $prodi)
                                <option value="{{ $prodi->id }}" @selected($dosen->prodi_id == $prodi->id)>{{ $prodi->nama }}
                                </option>
                            @endforeach
                        </select>
                    </div>
