            ...
            <div class="sidebar-brand">
                <a href="/" style="text-decoration:none">
                    <div class="sidebar-brand-full hstack gap-2 fw-bold">
                        <img height="32" src="/assets/brand/logo-ith.png" alt="ITH Logo">Digilib ITH
                    </div>
                    <img class="sidebar-brand-narrow" height="32" src="/assets/brand/logo-ith.png" alt="ITH Logo">
                </a>
            </div>
            ...
            @if (auth()->user()->role === 'admin')
                <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
                    ...
                    <ul class="nav-group-items">
                        ...
                        <li class="nav-item"><a class="nav-link" href="/master-data/prodi/"><span
