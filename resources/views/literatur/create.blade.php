            ...
            <form action="/dashboard/literatur" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <input class="form-control" id="penerbit" name="penerbit" placeholder="Silahkan Masukkan Penerbit">
                    </div>
